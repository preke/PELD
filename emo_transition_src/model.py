...
class Emo_Generation(BertPreTrainedModel):
    ...
    def forward(self, input_ids_1=None, input_ids_2=None, input_ids_3=None, attn_mask_1=None, attn_mask_2=None,
                attn_mask_3=None, \
                personality=None, init_emo=None):
        ...
        # utterance BERT embedding
        bert_outputs_1 = self.bert(input_ids_1, attention_mask=attn_mask_1)
        bert_hidden_1 = bert_outputs_1[0]

        bert_outputs_2 = self.bert(input_ids_2, attention_mask=attn_mask_2)
        bert_hidden_2 = bert_outputs_2[0]

        bert_hidden = torch.cat((bert_hidden_1, bert_hidden_2), 2)
